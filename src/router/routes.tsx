...
const Contractx = lazy(() => import('../components/ContractManagemenrt/Contractindex'));
...
const ContrAdmin = lazy(() => import('../components/security/ContractAdministration/securables'));
 const EmmargencyApproval= lazy(() => import('../components/ContractManagemenrt/contractApproval/emmargencyApproval/emmagencyApproval'));                               
 const FrameworkApproval= lazy(() => import('../components/ContractManagemenrt/contractApproval/frameworkApproval/frameworkApproval'));                               
...
//-------------------------security
const User = lazy(() => import('../components/security/User/Users'));
const Role = lazy(() => import('../components/security/Role/roles'));
...
const routes = [
    ...
    //------------------------------revenu contract
    {
      ...
      {
        path: '/contract/approval/framework',    
         element: <FrameworkApproval />,
      },
      {
        path: '/inspection/approval/Emmargency',    
         element: <EmmargencyInspectionApproval />,
      }, 
      {
        path: '/inspection/approval/framework',    
         element: <FrameworkInspectionApproval />,
      },  
      {
      ...
      },
      {
        path: '/ContractManagemenrt/contract/fiscalyearcontracttype',
         element: <FiscalYearContractType />,
      },
      {
    ...
    //         
    {
      ...
      },
      {
        path: '/lookup/revenu/PaternerServicePayment',
         element: <PaternerServicePayment />,
      },
      {
        path: '/revenu/revenucollectionadministration',
         element: <RevAdmin />,
      },
      
      {
        path: '/lookup/revenu/ServicePayment ',
         element: <ServicePayment />,
      },
      {
        path: '/lookup/revenu/Paterner ',
         element: <Paterner />,
      },
      {
        path: '/lookup/revenu/Business ',
         element: <Business />,
      },
      {
        path: '/lookup/revenu/Product ',
         element: <Product />,
      },
      {
        path: '/lookup/revenu/Payment ',
         element: <Payment />,
      },
      {
        path: '/lookup/revenu/Sources ',
         element: <Sources />,
      },
      {
        path: '/lookup/revenu/ViewPayment',
         element: <ViewPayment />,
      },
      
      {
        
        path: '/revenu/Revupload',
         element: <Revupload />,
      },
    
      {
      path: '/revenu/revenupayment',
       element: <Revenupayment />,
    },
    {
