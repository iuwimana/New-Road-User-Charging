            ...
            >
                ...
                <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
                    <div className="text-center relative pb-5">
                        ...
                        <h4 className="mb-1 dark:text-white">Interface settings</h4>
                        <p className="text-white-dark">with this part you are able to change the interface layout
                             </p>
                    </div>

                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base dark:text-white leading-none">Interface Lightness</h5>
                    ...
                    <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base dark:text-white leading-none">Interface Position Navigation</h5>
