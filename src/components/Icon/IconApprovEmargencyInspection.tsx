...
interface IconApprovEmargencyInspectionProps {
    className?: string;
    fill?: boolean;
    duotone?: boolean;
}

const IconApprovEmargencyInspection: FC<IconApprovEmargencyInspectionProps> = ({ className, fill = false, duotone = true }) => {
    return (
        <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export default IconApprovEmargencyInspection;
