...
interface IconApprovEmargencyProps {
    className?: string;
    fill?: boolean;
    duotone?: boolean;
}

const IconApprovEmargency: FC<IconApprovEmargencyProps> = ({ className, fill = false, duotone = true }) => {
    return (
        <svg
        viewBox="0 0 24 24"
        fill="currentColor"
...
export default IconApprovEmargency;
