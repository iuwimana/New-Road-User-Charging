...
interface IconApprovFrameworkInspectionProps {
    className?: string;
    fill?: boolean;
    duotone?: boolean;
}

const IconApprovFrameworkInspection: FC<IconApprovFrameworkInspectionProps> = ({ className, fill = false, duotone = true }) => {
    return (
        <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export default IconApprovFrameworkInspection;
