...
const AddPaymentSettingModalserviceorderModal = ({ isOpen, toggle, refresh, contractType }) => {
...
export default AddPaymentSettingModalserviceorderModal;
