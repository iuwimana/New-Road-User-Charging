...
import { createEvaluation,createEvaluationserviceorder } from '../../../services/ContractManagement/ContractSetting/inspectionEvaluationService';
import { getInspectionPlanDetailswithdescriptorByPlan,getInspectionPlanDetailswithdescriptorserviceorderByPlan } from '../../../services/ContractManagement/ContractSetting/inspectionplanDetailServices';
...
const AddInspectionEvaluationModal = ({ isOpen, toggle, refresh, planId }) => {
    ...
    useEffect(() => {
        if (planId && isOpen) {
            toast.info(`....${planId}`)
            getInspectionPlanDetailswithdescriptorserviceorderByPlan(planId).then((res) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            await createEvaluationserviceorder(payload);
