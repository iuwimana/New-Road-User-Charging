...
import { Card, CardFooter, CardHeader, CardBody, Col, Row } from 'reactstrap';
import { format } from 'date-fns';
import DatePicker from 'react-datepicker';
import 'react-datepicker/dist/react-datepicker.css';

class AddNewbankstatementModal extends Component {
    constructor(props) {
        super(props);
    ...
    handleSaves = async () => {
        try {
            ...
            await Correction.addNewbankstatement(
                bankstatementid,
                RevenueProductId,
                    ...
                    <Col>
                        <Card className="border-0 h-100 d-flex flex-column">
                            <CardHeader className="d-flex justify-content-between align-items-center bg-light">
                                <h5 className="mb-0">Add New Bank Statement</h5>
                            ...
                            <CardFooter className="bg-light d-flex justify-content-end py-3">
                                <div className="row g-2">
                                    <div className="col">
                                        <button type="button" className="btn btn-primary mx-2" onClick={this.handleSaves}>
                                            AddNew
                                        </button>
                                    </div>
                                    <div className="col">
                                        <button type="button" className="btn btn-secondary mx-2" onClick={this.props.onClose}>
                                            Close
                                        </button>
                                    </div>
                                </div>
...
AddNewbankstatementModal.propTypes = {
    show: PropTypes.bool.isRequired,
    onClose: PropTypes.func.isRequired,
};

export default AddNewbankstatementModal;
