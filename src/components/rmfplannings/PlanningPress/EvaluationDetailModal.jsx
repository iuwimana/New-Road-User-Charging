...
import { getEvaluationDetailsByInspection } from "../../../services/ContractManagement/ContractSetting/inspectionEvaluationService";
...
const EvaluationDetailModal = ({ isOpen, toggle, evaluation,refresh,planId }) => {
  ...
  useEffect(() => {
    if (evaluation && isOpen) {
      getEvaluationDetailsByInspection(planId).then((res) => {
        setDetails(res.data || []);
